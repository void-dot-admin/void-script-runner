...
/*
  ...
  *Just make sure to add this behaviour as a Server Side script for you Issue Picker scripted field
  *is NOT working as an Initializer
*/

def template = getFieldById(getFieldChanged())
def templateValue = template?.getValue().toString()
...
String [] labelsTemplate = issueTemplate?.getLabels() //ignore static type checking
// EXAMPLE FOR CF TEXT
...
// GET THE OPTION FOUND IN THE CATALOG FROM THE FIELD OPTIONS CONLY FOR SINGLE OR MULTI, TEXT DOESN'T HAVE THIS)
...
// ATTACH THE CATALOG VALUES TO THE SCREEN FIELDS
